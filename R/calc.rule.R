...
#' @param type The method used for constructing the stopping rule. Choices include a Pocock test ("Pocock"), a Wang-Tsiatis test ("WT"), a Bayesian beta-binomial model ("BB"), a truncated SPRT ("SPRT"), and a maximized SPRT ("MaxSPRT").
